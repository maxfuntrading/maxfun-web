import Gif from '@/assets/images/home/gif1.gif'
...
export default function TokenCard({className}: TokenCardProps) {
  ...
  return (
    <div className={clsx('w-full mdup:px-0 rounded-[0.625rem] overflow-hidden', className)}>
      <div className=" relative h-[18.75rem] bg-red-10">
        <img className='size-full object-cover' src={Gif} alt="" />
      ...
      <div className="relative bg-black-30 h-[13.84rem] px-[1.56rem] mdup:px-[0.875rem] pt-[1.44rem] pb-[1rem] mdup:py-[0.63rem] text-[0.875rem] flex flex-col">
        ...
        <div className=' '>
          ...
          <span className='font-semibold text-[0.875rem]'> $54.85k</span>
        </div>
